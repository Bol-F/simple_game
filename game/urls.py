...
urlpatterns = [
    path('api/character/creation/', views.CharacterCreationView.as_view(), name='character_creation_api'),
    path('api/battle/', views.BattleView.as_view(), name='battle_api'),
    path('api/level-up/', views.LevelUpView.as_view(), name='level_up_api'),
    path('api/weapon-selection/', views.WeaponSelectionView.as_view(), name='weapon_selection_api'),
